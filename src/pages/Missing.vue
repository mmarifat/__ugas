<template>
  <q-page>
    ...
    <q-table title="Missing Members" :data="rows" :columns="columns" row-key="id" :pagination="pagination" wrap-cells
...
export default class Missing extends Vue {
  ...
  exportTable() {
    ...
    exportFile('Missing-' + convertDate(new Date(), null, false) + '.xlsx',
